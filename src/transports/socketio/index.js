...
const Service = require('../../managers/service/lib/Service.js');
...
class SocketIoTransport extends Service {
    ...
    async start() {
        ...
        this.server.on('connection', (socket) => {
            ...
            contextRoutes(socket, ResponseObject);
            documentsRoutes(socket, this.db, ResponseObject); // Maybe this is a more readable => better way
